...
<script>
import ClearHeader from "../components/components/layout/clear_header";
import LeftSide from "../components/components/layout/left-side";
import RightSide from "../components/components/layout/right-side";
